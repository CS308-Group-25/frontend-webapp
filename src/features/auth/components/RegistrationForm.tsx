    ...
    <>
      ...
      <div className="flex w-full relative mb-5 border-b border-gray-200">
        <button
          ...
          className={`flex-1 pb-2.5 text-center font-semibold text-base transition-colors duration-200 ${
            activeTab === 'login'
      ...
      {activeTab === 'login' ? (
        <div className="text-center text-gray-500 py-10 animate-pulse">
          Login form details will be integrated here...
        </div>
      ) : (
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
            <div className="grid grid-cols-2 gap-3.5">
              ...
              <div className="relative">
                ...
                {errors.firstName && (
                  <p className="absolute -bottom-5 left-1 text-xs text-red-500 font-medium">{errors.firstName.message}</p>
                )}
              </div>
              ...
              <div className="relative">
                ...
                {errors.lastName && (
                  <p className="absolute -bottom-5 left-1 text-xs text-red-500 font-medium">{errors.lastName.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="relative pt-2">
              ...
              {errors.email && (
                <p className="absolute -bottom-5 left-1 text-xs text-red-500 font-medium">{errors.email.message}</p>
              )}
            </div>
            ...
            <div className="relative pt-2">
              ...
              {errors.password && (
                <p className="absolute -bottom-5 left-1 text-xs text-red-500 font-medium">{errors.password.message}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 gap-5 pt-2">
              <div className="relative">
                ...
                {errors.taxId && (
                  <p className="absolute -bottom-5 left-1 text-xs text-red-500 font-medium text-nowrap truncate w-full" title={errors.taxId.message}>{errors.taxId.message}</p>
                )}
              </div>
              ...
              <div className="relative">
                ...
                {errors.address && (
                  <p className="absolute -bottom-5 left-1 text-xs text-red-500 font-medium text-nowrap truncate w-full" title={errors.address.message}>{errors.address.message}</p>
                )}
              </div>
            </div>
